...
git clone --depth=1 https://github.com/xiangfeidexiaohuo/extra-ipk/tree/master/op-homebox/luci-app-homebox package/luci-app-homebox
...
sed -i "s/${orig_version}/R${date_version} by kivi/g" package/lean/default-settings/files/zzz-default-settings
